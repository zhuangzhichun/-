  ...
  <div class="shop_container">
    <ul class="shop_list">
      <li class="shop_li border-1px">
        <a>
          <div class="shop_left">
            <img class="shop_img" src="../../components/ShopList/img/shop/1.jpg">
          </div>
      ...
      <li class="shop_li border-1px">
        <a>
          <div class="shop_left">
            <img class="shop_img" src="../../components/ShopList/img/shop/2.jpg">
          </div>
          <div class="shop_right">
            <section class="shop_detail_header">
              <h4 class="shop_title ellipsis">锄禾日当午，汗滴禾下土</h4>
      ...
      <li class="shop_li border-1px">
        <a>
          <div class="shop_left">
            <img class="shop_img" src="../../components/ShopList/img/shop/3.jpg">
          </div>
          <div class="shop_right">
            <section class="shop_detail_header">
              <h4 class="shop_title ellipsis">锄禾日当午，汗滴禾下土</h4>
      ...
      <li class="shop_li border-1px">
        <a>
          <div class="shop_left">
            <img class="shop_img" src="../../components/ShopList/img/shop/4.jpg">
          </div>
          <div class="shop_right">
            <section class="shop_detail_header">
              <h4 class="shop_title ellipsis">锄禾日当午，汗滴禾下土</h4>
